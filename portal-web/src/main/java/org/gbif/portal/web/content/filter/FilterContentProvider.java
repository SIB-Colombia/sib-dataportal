...
public class FilterContentProvider implements ContentProvider {
  ...
  public void addCatalogueNumberTriplet(List<PropertyStoreTripletDTO> triplets, String queryNamespace, String catNo) {
    PropertyStoreTripletDTO triplet =
      new PropertyStoreTripletDTO(queryNamespace, catalogueNumberSubject, equalPredicate, catNo);
    triplets.add(triplet);
  }

  public void addCollectionCodeTriplet(List<PropertyStoreTripletDTO> triplets, String queryNamespace,
    String collectionCode) {
    PropertyStoreTripletDTO triplet =
      new PropertyStoreTripletDTO(queryNamespace, collectionCodeSubject, equalPredicate, collectionCode);
    triplets.add(triplet);
  }
  ...
  public void addGeoreferencedOnlyOccurrenceTriplets(List<PropertyStoreTripletDTO> triplets, String queryNamespace) {
    PropertyStoreTripletDTO cellIdNotNull =
      new PropertyStoreTripletDTO(queryNamespace, cellIdSubject, isNotNullPredicate, null);
  ...
  public void
    addIgnoreGeospatialIssuesOccurrenceTriplets(List<PropertyStoreTripletDTO> triplets, String queryNamespace) {
    PropertyStoreTripletDTO noGeospatialIssues =
      new PropertyStoreTripletDTO(queryNamespace, geoIssuesSubject, equalPredicate, 0);
  ...
  public void addIgnoreTaxonomicIssuesOccurrenceTriplets(List<PropertyStoreTripletDTO> triplets, String queryNamespace) {
    PropertyStoreTripletDTO noTaxonomicIssues =
      new PropertyStoreTripletDTO(queryNamespace, taxonIssuesSubject, equalPredicate, 0);
  ...
  public void addInstitutionCodeTriplet(List<PropertyStoreTripletDTO> triplets, String queryNamespace, String instCode) {
    PropertyStoreTripletDTO triplet =
      new PropertyStoreTripletDTO(queryNamespace, institutionCodeSubject, equalPredicate, instCode);
    triplets.add(triplet);
  }

  public void addIsTypeStatusOccurrenceTriplets(List<PropertyStoreTripletDTO> triplets, String queryNamespace) {
    PropertyStoreTripletDTO tripleDTO =
      new PropertyStoreTripletDTO(queryNamespace, typeStatusCountSubject, gtPredicate, 0);
  ...
  public void addNotGeoreferencedOccurrenceTriplets(List<PropertyStoreTripletDTO> triplets, String queryNamespace) {
    PropertyStoreTripletDTO cellIdNotNull =
      new PropertyStoreTripletDTO(queryNamespace, cellIdSubject, isNullPredicate, null);
    triplets.add(cellIdNotNull);
  }
  ...
  /**
   * Retrieves a list of entity ids for this query ignoring certain filters and translating others into filters that are
   * cell
   * density mappable.
   * 
   * @param criteria
  ...
  /**
   * @return the departmentOccurrenceFilter
   */
  public FilterDTO getDepartmentOccurrenceFilter() {
    return departmentOccurrenceFilter;
  }
  ...
  public CriteriaDTO getOccurrenceSearchCriteria(TaxonConceptDTO taxonConcept) {
    ...
    CriterionDTO criterionDTO =
      new CriterionDTO(classificationOccurrenceFilter.getId(), classificationOccurrenceFilter.getDefaultPredicateId(),
        conceptKey);
  ...
  public CriteriaDTO getTaxonomySearchCriteria(TaxonConceptDTO taxonConcept) {
    ...
    criteria.add(new CriterionDTO(taxonTaxonomyFilter.getId(), taxonTaxonomyFilter.getDefaultPredicateId(),
      taxonConcept.getTaxonName()));
    TaxonRankType taxonRankType = TaxonRankType.getRank(taxonConcept.getRank());
    if (taxonRankType != null)
      criteria.add(new CriterionDTO(rankTaxonomyFilter.getId(), rankTaxonomyFilter.getDefaultPredicateId(), Integer
        .toString(taxonRankType.getValue())));
  ...
  /**
   * A query is suitable for cell density if there exists one triplet against of the the supported entity types (taxon,
   * resource, provider, network, country)
   ...
   */
  public void setClassificationOccurrenceFilter(FilterDTO classificationOccurrenceFilter) {
  ...
  /**
   * @param departmentOccurrenceFilter the departmentOccurrenceFilter to set
   */
  public void setDepartmentOccurrenceFilter(FilterDTO departmentOccurrenceFilter) {
   ...
   */
  public void setGeoConsistencyOccurrenceFilter(FilterDTO geoConsistencyOccurrenceFilter) {
   ...
   */
  public void setGeoreferencedOccurrenceFilter(FilterDTO georeferencedOccurrenceFilter) {
   ...
   */
  public void setScientificNameOccurrenceFilter(FilterDTO scientificNameOccurrenceFilter) {
   ...
   */
  public void setTriplet2EntityTypeMappings(Map<String, String> triplet2EntityTypeMappings) {
