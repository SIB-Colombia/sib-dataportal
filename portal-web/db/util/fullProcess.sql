...
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-DF' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('distrito federal') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-DF' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('df') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-AC' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('acre') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-AC' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('ac') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-AL' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('alagoas') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-AL' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('al') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-AP' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('amapa') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-AP' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('amapá') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-AP' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('ap') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-AM' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('amazonas') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-AM' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('am') and (occurrence_record.iso_country_code='BR');	
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-BA' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('bahia') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-BA' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('ba') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-CE' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('ceara') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-CE' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('ceará') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-CE' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('ce') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-ES' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('espirito santo') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-ES' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('espírito santo') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-ES' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('es') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-GO' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('goias') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-GO' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('goiás') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-GO' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('go') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-MA' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('maranhao') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-MA' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('maranhão') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-MA' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('ma') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-MT' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('mato grosso') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-MT' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('mt') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-MS' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('mato grosso do sul') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-MS' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('ms') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-MG' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('minas gerais') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-MG' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('mg') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PA' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('para') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PA' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('pará') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PA' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('pa') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PB' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('paraiba') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PB' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('paraíba') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PB' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('pb') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PR' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('parana') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PR' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('paraná') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PR' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('pr') and (occurrence_record.iso_country_code='BR');	
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PE' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('pernambuco') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PI' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('piaui') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PI' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('piauí') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-PI' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('pi') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-RJ' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('rio de janeiro') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-RJ' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('rj') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-RN' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('rio grande do norte') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-RN' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('rn') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-RS' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('rio grande do sul') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-RS' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('rs') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-RO' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('rondonia') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-RO' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('rondônia') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-RO' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('ro') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-RR' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('roraima') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-RR' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('rr') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-SC' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('santa catarina') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-SC' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('sc') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-SP' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('sao paulo') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-SP' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('são paulo') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-SP' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('sp') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-SE' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('sergipe') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-SE' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('se') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-TO' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('tocantins') and (occurrence_record.iso_country_code='BR');
update occurrence_record, raw_occurrence_record set iso_department_code ='BR-TO' where raw_occurrence_record.id = occurrence_record.id and lower (raw_occurrence_record.state_province)=('to') and (occurrence_record.iso_country_code='BR');
