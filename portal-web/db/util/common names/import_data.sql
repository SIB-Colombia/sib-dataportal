 ...
 * Import the families
 */
drop table if exists col_families;
create table col_families (    
    ...
    index index_database(database_name));
load data 
    infile 'C://Temp//families.txt'
into table
    col_families;
...
create table col_taxa (    
    ...
    index index_rank(rank));
load data 
    infile 'C://Temp///taxonomy.txt'
into table
    col_taxa;
 ...
 * Import distribution
 */
drop table if exists col_distribution;
create table col_distribution (    
    name_code varchar(100) not null,
    distribution varchar(555) not null
);
load data 
    infile 'C://Temp//distribution.txt'
into table
    col_distribution;
 ...
 */
drop table if exists col_vernacular_name;
 ...
 */
drop table if exists col_publication;
