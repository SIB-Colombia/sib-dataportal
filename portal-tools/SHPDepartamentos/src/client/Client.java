...
public class Client {
        ...
        private void insertResults(int parts) throws RemoteException {
                ...
                try {
                       if (resulter.insertResult(clientName,new LinkedList<Record>(records))) {
	                	   worked += records.size();
                        ...
                        System.out.println("There was a problem trying send the results to the server.");
        ...
        private void work() {
                ...
                try {
                        shapeFileManager.setDepartamentos(shapeFileManager.getDepartamentosFromCoordinates(records));
