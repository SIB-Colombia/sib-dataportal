...
public class Record implements Serializable {
	...
	public Record(String iso_country_code_calculated, double latitude,
			double longitude, int nudConceptId, int id) {
		super();
	...
	public String toString() {
		return id + "," + nub_concept_id + "," + iso_country_code_calculated
				+ "," + latitude + "," + longitude;
	}
}
