...
public class ClientConfig {
        ...
        private static final String XML_ISO_A2 = "iso_a2";
        ...
        private void readFromXML() throws JDOMException, IOException {
                ...
                for (Element column : columns) {
                        ...
                        if (name.equalsIgnoreCase(XML_ISO_A2)) {
                                nameColumnIso = column.getText();
                        } else {
                                if (name.equalsIgnoreCase(XML_ADMIN)) {
                                	nameColumnAdmin = column.getText();
                                } else {
                               	 // unknow column
                               }
                        }
        ...
        private void createDeafaultXML() throws IOException {
                ...
                shape.setAttribute(XML_PATH, "C://Users//PC 2//Desktop//Paises//10m_admin_0_countries.shp");

                Element columnIso = new Element("column");
                columnIso.setAttribute(XML_NAME, XML_ISO_A2);
                columnIso.setText("iso");
                Element columnAdmin = new Element("column");
                columnAdmin.setAttribute(XML_NAME, XML_ADMIN);
                columnAdmin.setText("admin");
               

                shape.addContent(columnIso);
                shape.addContent(columnAdmin);
