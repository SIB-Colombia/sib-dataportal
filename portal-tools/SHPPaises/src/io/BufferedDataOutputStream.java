 ...
 * 
 * One routine is added to the public interface of DataOutput,
 * writePrimitiveArray. This routine provides efficient protocols for writing
 * arrays.
 * 
...
public class BufferedDataOutputStream extends BufferedOutputStream implements
		DataOutput {
	...
	public void writeFloat(float f) throws IOException {
		...
		byte[] b = new byte[4]; // Repeat this from writeInt to save method
								// call.
	...
	public void writePrimitiveArray(Object o) throws IOException {
		...
		if (className.charAt(1) == '[') {
			...
			case 'B':
				...
				break;
			case 'C':
				writeCharArray((char[]) o);
				break;
			case 'S':
				writeShortArray((short[]) o);
				break;
			case 'I':
				writeIntArray((int[]) o);
				break;
