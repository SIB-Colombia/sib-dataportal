...
public class Record implements Serializable {
    ...
    public Record(String marineZone, double latitude, double longitude, int nudConceptId, int id) {
            super();
     ...
     * @deprecated
     */
    public Record(String marineZone, double latitude, double longitude, int nudConceptId, String canonical, int id) {
            super();
            this.marineZone = marineZone;
            this.latitude = latitude;
            this.longitude = longitude;
    ...
    public String toString() {
            return id + "," + nub_concept_id + "," + marineZone + "," + latitude + "," + longitude;
    }
}
