...
public class Record implements Serializable {
	...
	public Record(String protected_area, double latitude, double longitude,
	...
	public void setProtectedArea(String protected_area) {
		this.protected_area = protected_area;
	}
	...
	public String toString() {
		return id + "," + nub_concept_id + "," + protected_area + ","
				+ latitude + "," + longitude;
	}
}
