...
public class ClientConfig {
	...
	private static final String XML_NOMSZH = "nomszh";
	...
	private void readFromXML() throws JDOMException, IOException {
		...
		for (Element column : columns) {
			...
			if (name.equalsIgnoreCase(XML_FID)) {
				...
				if (name.equalsIgnoreCase(XML_NOMSZH)) {
	...
	private void createDeafaultXML() throws IOException {
		...
		shape.setAttribute(XML_PATH, "./Shapefile/SZH_Colombia_2013.shp");
		...
		columnNom.setAttribute(XML_NAME, XML_NOMSZH);
		columnNom.setText("nomszh");
