...
public class Record implements Serializable {
    ...
    public Record(String paramo, double latitude, double longitude, int nudConceptId, int id) {
            super();
            this.paramo = paramo;
     ...
     * @deprecated
     */
    public Record(String paramo, double latitude, double longitude, int nudConceptId, String canonical, int id) {
            super();
            this.paramo = paramo;
            this.latitude = latitude;
            this.longitude = longitude;
    ...
    public String toString() {
            return id + "," + nub_concept_id + "," + paramo + "," + latitude + "," + longitude;
    }
}
