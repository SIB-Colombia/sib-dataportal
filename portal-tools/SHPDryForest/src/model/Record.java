...
public class Record implements Serializable {
	...
	public Record(String dry_forest, double latitude, double longitude,
			int nudConceptId, int id) {
		super();
		this.dry_forest = dry_forest;
	...
	public void setDryForest(String dry_forest) {
		this.dry_forest = dry_forest;
	}
	...
	public String toString() {
		return id + "," + nub_concept_id + "," + dry_forest + "," + latitude
				+ "," + longitude;
	}
}
