 ...
 * particular ecosystem with a count.
 * 
 * @author dmartin
 */
public class TaxonEcosystem extends HibernateDaoSupport {

  protected TaxonEcosystemId key;
   ...
   * @return the key
   */
  public TaxonEcosystemId getKey() {
    return key;
  }
   ...
   */
  public void setKey(TaxonEcosystemId key) {
    this.key = key;
  }
