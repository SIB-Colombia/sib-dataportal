...
/**
 * A join entity for taxon and zonificacion. Represents occurrences of a taxon in a
 * particular  zonificacion with a count.
 */
public class TaxonZonificacion extends HibernateDaoSupport {

  protected TaxonZonificacionId key;

  protected TaxonConceptLite taxonConceptLite;

  protected int count;

	public TaxonZonificacionId getKey() {
		return key;
	}
	
	public void setKey(TaxonZonificacionId key) {
		this.key = key;
	}
