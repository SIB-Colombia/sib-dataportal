...
public class TaxonConceptDAOImpl extends HibernateDaoSupport implements TaxonConceptDAO {
   ...
   *      org.gbif.portal.model.taxonomy.TaxonRank, org.gbif.portal.model.taxonomy.TaxonRank)
   */
  public int countChildConcepts(final long parentId, final TaxonRank parentRank, final TaxonRank childRank,
    final boolean countSynonyms, final boolean onlyCountAccepted, final boolean allowUnconfirmed) {
  ...
  /**
   * @see org.gbif.portal.dao.taxonomy.TaxonConceptDAO#countTaxonConcepts(java.lang.String, boolean,
   *      org.gbif.portal.model.taxonomy.TaxonRank, java.lang.Long, java.lang.Long, java.lang.Long, java.lang.String,
   *      java.util.Date)
   */
  @SuppressWarnings("unchecked")
  public Long countTaxonConcepts(final String nameStub, final boolean fuzzy, final TaxonRank taxonRank,
    final Long dataProviderId, final Long dataResourceId, final Long resourceNetworkId,
    final String hostIsoCountryCode, final Date modifiedSince) {
    HibernateTemplate template = getHibernateTemplate();
  ...
  /**
   * @see org.gbif.portal.dao.taxonomy.TaxonConceptDAO#findTaxonConcepts(java.lang.String, java.lang.String, boolean,
   *      org.gbif.portal.model.taxonomy.TaxonRank, java.lang.Long, java.lang.Long, java.lang.Long, java.lang.String,
   *      java.util.Date, int, int)
   */
  @SuppressWarnings("unchecked")
  public List<TaxonConcept> findTaxonConcepts(final String canonical, final String specificEpithet,
    final boolean fuzzy, final TaxonRank taxonRank, final Long dataProviderId, final Long dataResourceId,
    final Long resourceNetworkId, final String hostIsoCountryCode, final Date modifiedSince,
    final boolean allowUnconfirmed, final boolean sortAlphabetically, final int startIndex, final int maxResults) {
    HibernateTemplate template = getHibernateTemplate();
    return (List<TaxonConcept>) template.execute(new HibernateCallback() {

      public Object doInHibernate(Session session) {
        if (logger.isDebugEnabled())
          logger.debug("searching with: '" + canonical + "' and specificEpithet: '" + specificEpithet
...
// }
   ...
   * 
   * @see org.gbif.portal.dao.taxonomy.TaxonConceptDAO#findTaxonConceptsForCommonName(java.lang.String, boolean, int,
   *      int)
   */
  @SuppressWarnings("unchecked")
   ...
   */
  @SuppressWarnings("unchecked")
  public List<TaxonConcept> findTaxonConceptsWithSameCanonicalAndRankAs(final long taxonConceptId,
    final Long dataProviderId, final Long dataResourceId, final int startIndex, final int maxResults) {
    HibernateTemplate template = getHibernateTemplate();
    return (List<TaxonConcept>) template.execute(new HibernateCallback() {

      public Object doInHibernate(Session session) {
        StringBuffer sb =
          new StringBuffer("select target from TaxonConcept target, TaxonConcept source"
            + " inner join fetch target.dataResource" + " inner join fetch target.dataProvider"
            + " inner join fetch target.taxonName" + " where source.taxonName.canonical = target.taxonName.canonical"
            + " and source.taxonName.taxonRank = target.taxonName.taxonRank" + " and target.id <> :id"
            + " and source.id = :id");
        if (dataProviderId != null)
  ...
  public List<TaxonConcept> getAuthoritativeTaxonConceptsForNubTaxonConcept(final Long nubConceptId) {
    ...
    return (List<TaxonConcept>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        ...
        Query query =
          session.createQuery("select partner from TaxonConcept partner, TaxonConcept nub"
            + " inner join fetch partner.taxonName" + " where partner.partnerConceptId = :nubConceptId"
            + " and nub.id = partner.partnerConceptId" + " and nub.partnerConceptId = partner.id"
            + " and partner.isNubConcept = false" + " and partner.taxonomicPriority <= 10");
  ...
  public List<TaxonConcept> getChildConceptsFor(final long taxonConceptId, final boolean allowUnconfirmed) {
    ...
    return (List<TaxonConcept>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        StringBuffer sb =
          new StringBuffer("from TaxonConcept tc" + " inner join fetch tc.taxonName"
  ...
  public List<TaxonConceptLite> getCountryRootConceptsFor(final String isoCountryCode) {
    ...
    return (List<TaxonConceptLite>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        ...
        Query query =
          session.createQuery("select tct.taxonConceptLite from TaxonCountry tct"
            + " inner join fetch tct.taxonConceptLite.taxonNameLite"
            + " where tct.key.isoCountryCode = :isoCountryCode" + " and tct.taxonConceptLite.taxonRank=:taxonRank"
  ...
  public List<TaxonConcept> getDataProviderRootConceptsFor(final long dataProviderId) {
    ...
    return (List<TaxonConcept>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        Query query =
          session.createQuery("from TaxonConcept tc" + " inner join fetch tc.taxonName"
            + " where tc.dataProvider.id = :dataProviderId" + " and tc.parentConcept.id is null"
            + " and tc.isAccepted=true" + " order by tc.taxonRank asc, tc.taxonName.canonical");
        query.setParameter("dataProviderId", dataProviderId);
        query.setCacheable(true);
        query.setMaxResults(maxChildConcepts);
        return query.list();
  ...
  public List<TaxonConcept> getDataResourceRootConceptsFor(final long dataResourceId) {
    ...
    return (List<TaxonConcept>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        Query query =
          session.createQuery("from TaxonConcept tc" + " inner join fetch tc.taxonName"
            + " where tc.dataResource.id = :dataResourceId" + " and tc.parentConcept.id is null"
            + " and tc.isAccepted=true" + " order by tc.taxonRank asc, tc.taxonName.canonical");
        query.setParameter("dataResourceId", dataResourceId);
        query.setCacheable(true);
        query.setMaxResults(maxChildConcepts);
  ...
  public List<TaxonConceptLite> getDepartmentRootConceptsFor(final String isoDepartmentCode) {
    ...
    return (List<TaxonConceptLite>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        ...
        // select..where parent_concept_id is null was soo slooow
        Query query =
          session.createQuery("select tdt.taxonConceptLite from TaxonDepartment tdt"
            + " inner join fetch tdt.taxonConceptLite.taxonNameLite"
            + " where tdt.key.isoDepartmentCode = :isoDepartmentCode"
            + " and tdt.taxonConceptLite.taxonRank=:taxonRank" + " and tdt.taxonConceptLite.isAccepted=true"
  ...
  public List<TaxonConceptLite> getProtectedAreaRootConceptsFor(final String protectedArea) {
    ...
    return (List<TaxonConceptLite>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        ...
        // select..where parent_concept_id is null was soo slooow
        Query query =
          session.createQuery("select tct.taxonConceptLite from TaxonProtectedArea tpa"
      ...
      public Object doInHibernate(Session session) {
        Query query =
          session.createQuery("from TaxonConcept tc" + " inner join fetch tc.taxonName"
            ...
            + " left join fetch tc.genusConcept left join fetch tc.genusConcept.taxonNameLite"
            + " left join fetch tc.speciesConcept left join fetch tc.speciesConcept.taxonNameLite"
            + " inner join fetch tc.dataResource" + " inner join fetch tc.dataProvider" + " where tc.id=?");
        query.setParameter(0, taxonConceptId);
        query.setCacheable(true);
        return query.uniqueResult();
      }
  ...
  public List<TaxonConceptLite> getLiteChildConceptsFor(final long taxonConceptId, final boolean allowUnconfirmed) {
    ...
    return (List<TaxonConceptLite>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        StringBuffer sb =
          new StringBuffer("from TaxonConceptLite tcl inner join fetch tcl.taxonNameLite "
   ...
   */
  @SuppressWarnings("unchecked")
  public List<TaxonConceptLite> getLiteChildConceptsFor(final long taxonConceptId, final String isoCountryCode,
    ...
    return (List<TaxonConceptLite>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        StringBuffer sb =
          new StringBuffer("select tct.taxonConceptLite from TaxonCountry tct "
            + "inner join fetch tct.taxonConceptLite.taxonNameLite");
   ...
   */
  @SuppressWarnings("unchecked")
  public List<TaxonConceptLite> getLiteChildConceptsForDepartment(final long taxonConceptId,
    final String isoDepartmentCode, final boolean allowUnconfirmed) {
    ...
    return (List<TaxonConceptLite>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        StringBuffer sb =
          new StringBuffer("select tdt.taxonConceptLite from TaxonDepartment tdt "
            + "inner join fetch tdt.taxonConceptLite.taxonNameLite");
        sb.append(" where tdt.taxonConceptLite.parentConceptId = :taxonConceptId and tdt.taxonConceptLite.isAccepted=true "
          + "and  tdt.key.isoDepartmentCode =:isoDepartmentCode ");

        if (!allowUnconfirmed) {
          sb.append(" and tdt.taxonConceptLite.taxonomicPriority<=");
          sb.append(taxonomicPriorityThreshold);
        }
        sb.append("order by tdt.taxonConceptLite.taxonRank, tdt.taxonConceptLite.taxonNameLite.canonical");
        Query query = session.createQuery(sb.toString());
        query.setParameter("taxonConceptId", taxonConceptId);
        query.setParameter("isoDepartmentCode", isoDepartmentCode);
        query.setMaxResults(maxChildConcepts);
  ...
  public TaxonConcept getNubConceptFor(final long taxonConceptId) {
    ...
    return (TaxonConcept) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        Query query =
          session
            .createQuery("select tc.partnerConcept from TaxonConcept tc"
  ...
  public TaxonConcept getParentConceptFor(final long taxonConceptId) {
    ...
    return (TaxonConcept) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        Query query =
          session
            .createQuery("select tc.parentConcept from TaxonConcept tc"
  ...
  public TaxonConcept getTaxonConceptForRemoteId(final Long dataProviderId, final Long dataResourceId,
    ...
    return (TaxonConcept) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        StringBuffer sb =
          new StringBuffer("select rc.taxonConcept from RemoteConcept rc" + " inner join rc.taxonConcept tc "
            + " left join fetch tc.dataResource" + " left join fetch tc.dataProvider"
  ...
  public List<TaxonConcept> getTaxonConceptForRemoteId(final String remoteId) {
    ...
    return (List<TaxonConcept>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        Query query =
          session.createQuery("from TaxonConcept tc" + " inner join fetch tc.taxonName"
            + " inner join fetch tc.remoteConcepts as remoteConcept" + " left join fetch tc.dataResource"
            + " left join fetch tc.dataProvider" + " left join fetch tc.parentConcept"
            + " left join fetch tc.kingdomConcept left join fetch tc.kingdomConcept.taxonNameLite"
            + " left join fetch tc.phylumConcept left join fetch tc.phylumConcept.taxonNameLite"
            + " left join fetch tc.orderConcept left join fetch tc.orderConcept.taxonNameLite"
            + " left join fetch tc.classConcept left join fetch tc.classConcept.taxonNameLite"
  ...
  public List<Long> getTaxonConceptIdsForNubTaxonConcept(final long nubConceptId) {
    ...
    return (List<Long>) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        Query query =
          session.createQuery("select tc.id from TaxonConcept tc" + " where tc.partnerConceptId = :partnerConceptId"
  ...
  public TaxonConceptLite getTaxonConceptLiteFor(final long taxonConceptId) {
    ...
    return (TaxonConceptLite) template.execute(new HibernateCallback() {
      ...
      public Object doInHibernate(Session session) {
        Query query =
          session.createQuery("from TaxonConceptLite tc" + " inner join fetch tc.taxonNameLite" + " where tc.id = ?");
        query.setParameter(0, taxonConceptId);
        query.setCacheable(true);
        return query.uniqueResult();
      }
