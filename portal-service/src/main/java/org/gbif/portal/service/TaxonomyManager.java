 ...
 * enable limiting results and paging through results (see <code>SearchConstraints.startIndex</code> and
 * <code>SearchConstraints.maxResults</code> ).
 * 
...
public interface TaxonomyManager {
  ...
  public int countChildConceptsFor(String taxonConceptKey, TaxonRankType childConceptRank, boolean countSynonyms,
    boolean onlyCountAccepted, boolean allowUnconfirmed) throws ServiceException;
  ...
  public List<CommonNameDTO>
    findCommonNamesForTaxonConcept(String taxonConceptKey, SearchConstraints searchConstraints) throws ServiceException;
   ...
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public SearchResultsDTO findSpeciesConcepts(String scientificName, String specificEpithet, boolean fuzzy,
   ...
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public SearchResultsDTO findTaxonConcepts(String scientificName, boolean fuzzy, String rank, String dataProviderKey,
    String dataResourceKey, String resourceNetworkKey, String hostIsoCountryCode, String languageCode,
   ...
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public List<BriefTaxonConceptDTO> getChildConceptsForMarineZone(String taxonConceptKey, String marineId,
    boolean allowUnconfirmed) throws ServiceException;
   ...
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public List<BriefTaxonConceptDTO> getChildConceptsForProtectedArea(String taxonConceptKey, String protectedId,
    boolean allowUnconfirmed) throws ServiceException;
   ...
   * @param isoCountryCode if retrieveChildren is set to true, setting isoCountryCode will only bring back child concept
   *        with occurrence data in this country
   * @return List of BriefTaxonConcept for the full tree for this concept
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public List<BriefTaxonConceptDTO> getClassificationFor(String taxonConceptKey, boolean includeHigherTaxa,
    boolean retrieveChildren, String isoCountryCode, boolean retrieveChildCounts, boolean allowUnconfirmed)
    throws ServiceException;
   ...
   * @param taxonConceptKey the key of a taxon concept to retrieve the classification for, nullable.
   * @param retrieveChildren if set to true will gather child concepts as well as parent concepts
   * @param isoDepartmentCode if retrieveChildren is set to true, setting isoDepartmentCode will only bring back child
   *        concept with occurrence data in this department
   * @return List of BriefTaxonConcept for the full tree for this concept
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
   ...
   * @param taxonConceptKey the key of a taxon concept to retrieve the classification for, nullable.
   * @param retrieveChildren if set to true will gather child concepts as well as parent concepts
   * @param complexId if retrieveChildren is set to true, setting complexId will only bring back child
   *        concept with occurrence data in this county
   * @return List of BriefTaxonConcept for the full tree for this concept
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
   ...
   * @param taxonConceptKey the key of a taxon concept to retrieve the classification for, nullable.
   * @param retrieveChildren if set to true will gather child concepts as well as parent concepts
   * @param marineZone if retrieveChildren is set to true, setting marineId will only bring back child
   *        concept with occurrence data in this county
   * @return List of BriefTaxonConcept for the full tree for this concept
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  ...
  /**
   * Retrieves a count against all marine zones for this taxon concept.
   * 
   * @param taxonConcept
   * @return
   * @throws ServiceException
  ...
  /**
   * Retrieves a count against all protected areas for this taxon concept.
   * 
   * @param taxonConcept
   * @return
   * @throws ServiceException
  ...
  /**
   * Retrieves a count against all ecosystems for this taxon concept.
   * 
   * @param taxonConcept
   * @return
   * @throws ServiceException
  ...
  /**
   * Returns a list of TaxonConcepts that are the root concepts for the taxonomy of a department
   * A root concept is a concept with no parent concept. This would typically be a higher concept
   * of rank kingdom for example.
   * 
   * @param isoDepartmentCode The department to search, nullable
   * @return List of BriefTaxonConceptDTOs ordered alphabetically by Scientific Name
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
   ...
   * of rank kingdom for example.
   * 
   * @param marineId The marine zone to search, nullable
   * @return List of BriefTaxonConceptDTOs ordered alphabetically by Scientific Name
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public List<BriefTaxonConceptDTO> getRootTaxonConceptsForMarineZone(String marineId) throws ServiceException;
   ...
   * of rank kingdom for example.
   * 
   * @param protectedId The protected area to search, nullable
   * @return List of BriefTaxonConceptDTOs ordered alphabetically by Scientific Name
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
  public List<BriefTaxonConceptDTO> getRootTaxonConceptsForProtectedArea(String protectedId) throws ServiceException;
   ...
   * of rank kingdom for example.
   * 
   * @param ecosystemId The ecosystem to search, nullable
   * @return List of BriefTaxonConceptDTOs ordered alphabetically by Scientific Name
   * @throws ServiceException indicate a failure to retrieve the data due to a network/database connection
   */
   ...
   * retrieve a concept count for a particular data resource by supplyinga data resource key and providing a null
   * nameStub.
